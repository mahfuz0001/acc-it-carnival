            ...
            <CardContent className="space-y-4">
              ...
              {process.env.NODE_ENV === "development" && this.state.error && (
                <details className="bg-[#131943] p-3 rounded border border-[#556492]/30">
                  <summary className="text-red-400 text-xs cursor-pointer">Error Details (Development)</summary>
              ...
              <div className="flex gap-2">
                <Button onClick={this.handleRetry} className="flex-1 bg-[#84C25D] hover:bg-[#6ba348]">
