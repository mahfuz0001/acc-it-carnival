...
export default function SubmitEntryPage(props: { params: Promise<{ id: string }> }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await supabase.from("registrations").update({ status: "submitted" }).eq("id", registration.id)
    ...
    return (
      <div className="container px-4 py-12 md:px-6 flex flex-col items-center">
        <Alert variant="destructive" className="max-w-md">
          ...
          <AlertDescription>Event not found. Please check the URL and try again.</AlertDescription>
        </Alert>
      ...
      <div className="container px-4 py-12 md:px-6">
        <div className="flex flex-col items-center">
          <div className="w-full max-w-2xl">
            <h1 className="text-3xl font-bold mb-6 text-white">Submit Entry for {event.name}</h1>
            ...
            <Card className="bg-gradient-to-br from-[#556492]/10 to-[#7683A4]/10 border-[#556492]/30">
              <CardHeader>
                ...
                <CardDescription className="text-[#D4D4D6]">
                  Submit your entry for this event by providing a Google Drive link
                </CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    />
                    <p className="text-sm text-[#D4D4D6]">Please provide a Google Drive link to your submission</p>
                  </div>
