    ...
    <div className="container px-4 py-12 md:px-6">
      <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8">
        <div className="space-y-2">
          <h1 className="text-3xl font-bold tracking-tighter text-[#131943] sm:text-4xl md:text-5xl">Event Schedule</h1>
      ...
      <Tabs defaultValue="day1" className="w-full">
        ...
        <TabsContent value="day1">
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[#131943] mb-4">Day 1 - August 15, 2025</h2>
        ...
        <TabsContent value="day2">
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[#131943] mb-4">Day 2 - August 16, 2025</h2>
            <div className="grid gap-4">
        ...
        <TabsContent value="day3">
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-[#131943] mb-4">Day 3 - August 17, 2025</h2>
            <div className="grid gap-4">
      ...
      <div className="mt-12 bg-[#EBEBEB] rounded-lg p-6">
        ...
        <ul className="space-y-2 text-sm text-muted-foreground">
          <li>
            • Online submissions for Graphics Design, Video Editing, MemeCon, and Photography are due by August 15,
            2025, 11:59 PM
          </li>
          <li>• Participants must arrive 30 minutes before their scheduled events</li>
