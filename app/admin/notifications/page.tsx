      ...
      <div className="min-h-screen bg-[#131943] flex items-center justify-center p-4">
        <Card className="w-full max-w-md bg-[#556492]/20 border-[#556492]/30">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-[#D4D4D6]">You don't have permission to access this page.</p>
          </CardContent>
        </Card>
      </div>
    )
    ...
    <ErrorBoundary>
      <div className="min-h-screen bg-[#131943] py-8">
        <div className="container mx-auto px-4 max-w-2xl">
          <div className="mb-8">
            <h1 className="text-3xl font-bold text-white mb-2">Send Push Notifications</h1>
            <p className="text-[#D4D4D6]">Send notifications to all users or specific users</p>
          </div>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <Label htmlFor="sendToAll" className="text-white flex items-center gap-2">
